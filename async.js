...
async function modifyWallet(userName){
    let pwd, keystore;
    ...
    switch(modify.value){
        case 1:
            ...
            await accountCreation();
            keystore = web3.eth.accounts.wallet.encrypt(pwd.value);
...
async function importWallet(){
    ...
    readFile(userName.value).then(function(data) {
        var data1 = JSON.parse(data);
                ...
                modifyWallet(userName.value);
    })
        .catch(function() {if(found == 0) { 
